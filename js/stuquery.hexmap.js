...
(function(){
	...
	if(this.tag != "code" && this.container.find('code').length==1){
	    ...
	    var i = 0;
            var terrain1=["1A","2B_1","3A","8A","9B","10A","11B","12B","15B_2","16B_2","S1B","V3B","white"];
            var terrain2r=["2B_2","2B_3","4A_1","4A_3","4B_1","4B_2","13A_1","13A_2","13B_1","13B_2","14A_2","14B_1","15A_1","15B_1","16A_2","16B_1","17A_1","17A_2","17A_3","17B_1","17B_2","17B_3"];
            var terrain2=["5A","6A","6B","7B","11A","S3A","V3A"];
            var terrain2h=["7A","14B_2"];
            var terrain3=["1B","2A_1","2A_3","4B_3","5B","8B","9A","12A","18B_1","18B_2","18B_3","S3B"];
            var terrain3r=["2A_2","4A_2","14A_1","15A_2","16A_1","18A_1","18A_2","18A_3"];
            var other=["S1A","S2A","S2B","V1A","V1B","V2B"];
            var terrain3h=["S1A","V1A"];
	    for(var id in json.hexes){
                let orientation=json.hexes[id].orient;
                let n=json.hexes[id].n;
                let overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone fullhex'></div>";
                
                if (terrain2.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone half1'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone half2'></div>";
                if (terrain2r.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone half1r'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone half2r'></div>";
                if (terrain2h.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone half1h'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone half2h'><img src='images/icon/francais.png'></div>";
                if (terrain3.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third1'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third2'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='3' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third3'></div>";
                if (terrain3r.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third1r'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third2r'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='3' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third3r'></div>";
                if (terrain3h.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third1h'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third2h'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='3' data-html='true' data-toggle='tooltip' data-units='' title='empty' class='zone third3h'></div>";
                if (typeof orientation=="undefined") orientation=0; 
		html += '<'+this.tag+' class="hex" tabindex="0" data-id="'+id+'" data-r="'+json.hexes[id].r+'" data-o="'+orientation+'" data-q="'+json.hexes[id].q+'">'+overlay+'<div class="hexinner"><div class="hexcontent">'+(typeof this.options.formatLabel==="function" ? this.options.formatLabel(id,json.hexes[id]) : '')+'</div></div></'+this.tag+'>';
	...
	*/
	...
	/*var zones = this.container.find('.zone');
          for (i=0;i<zones.length;i++) {
          console.log(zones[i]);
          zones[i].id=i;
          zones[i].onclick=function(e){

          console.log("clicking on zone "+this.id);
	...
	this.hex = {'wide': this.hexes[0].el[0].clientWidth,'tall':this.hexes[0].el[0].clientHeight};
        ...
        console.log(">>>"+this.hex.wide+" x "+this.hex.tall);
    ...
    */
    ...
    HexMap.prototype.resize = function(){
        console.log("Hexmap resize"+this.wide+" "+padding);
