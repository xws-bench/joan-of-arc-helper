...
(function(){
	...
	if(this.tag != "code" && this.container.find('code').length==1){
	    ...
	    for(var id in json.hexes){
                ...
                let overlay="<div data-z='1' class='zone fullhex'></div>";
                if (terrain2.includes(n))
                    overlay="<div data-z='1' class='zone half1'></div><div data-z='2' class='zone half2'></div>";
                if (terrain2r.includes(n))
                    overlay="<div data-z='1' class='zone half1r'></div><div data-z='2' class='zone half2r'></div>";
                if (terrain2h.includes(n))
                    overlay="<div data-z='1' class='zone half1h'></div><div data-z='2' class='zone half2h'><img src='mini/house1.png' style='z-index:999;opacity:1;position:absolute'></div>";
                if (terrain3.includes(n))
                    overlay="<div data-z='1' class='zone third1'></div><div data-z='2' class='zone third2'></div><div data-z='3' class='zone third3'></div>";
                if (terrain3r.includes(n))
                    overlay="<div data-z='1' class='zone third1r'></div><div data-z='2' class='zone third2r'></div><div data-z='3' class='zone third3r'></div>";
                if (terrain3h.includes(n))
                    overlay="<div data-z='1' class='zone third1h'></div><div data-z='2' class='zone third2h'></div><div data-z='3' class='zone third3h'></div>";
