...
(function(){
	...
	if(this.tag != "code" && this.container.find('code').length==1){
	    ...
	    for(var id in json.hexes){
                ...
                let overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone fullhex'></div>";
                if (terrain2.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone half1'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' title='empty' class='zone half2'></div>";
                if (terrain2r.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone half1r'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' title='empty' class='zone half2r'></div>";
                if (terrain2h.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone half1h'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' title='empty' class='zone half2h'><img src='images/icon/francais.png'></div>";
                if (terrain3.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone third1'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' title='empty' class='zone third2'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='3' data-html='true' data-toggle='tooltip' title='empty' class='zone third3'></div>";
                if (terrain3r.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone third1r'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' title='empty' class='zone third2r'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='3' data-html='true' data-toggle='tooltip' title='empty' class='zone third3r'></div>";
                if (terrain3h.includes(n))
                    overlay="<div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='1' data-html='true' data-toggle='tooltip' title='empty' class='zone third1h'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='2' data-html='true' data-toggle='tooltip' title='empty' class='zone third2h'></div><div ondrop='drop(event)' ondragover='allowDrop(event)' data-z='3' data-html='true' data-toggle='tooltip' title='empty' class='zone third3h'></div>";
