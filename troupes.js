...
class Unite {
    ...
    static pgs() { return [
        ...
        {nom:"Jean Stuart de Buchan",niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[blanc],commandement:[AA,1],pdv:2,cohesion:true,impetueux:true,modattaque:annule1recul,maj:4,dates:[1404,1424],source:"https://fr.wikipedia.org/wiki/John_Stuart_(3e_comte_de_Buchan)",blason:true,cout:300,moral:3,desc:"%ACTIVATED%%TOURCOND% %LEGENDE%: + <span class='commandement'>&nbsp;&nbsp;&nbsp; 1</span> / <span class='commandement'><span style='color:black;text-shadow:1px 1px;'>1</span></span>"},    
        {nom:"Jean Stuart de Buchan",niv:2,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,blanc],defense:[blanc],pdv:3,charge:true,cohesion:true,impetueux:true,modattaque:annule2recul,commandement:[AA,3],dates:[1404,1424],commandement:[1,2],source:"https://fr.wikipedia.org/wiki/John_Stuart_(3e_comte_de_Buchan)",blason:true,moral:3,desc:"Sergents d'armes%HERE%: + %CHARGE%%BR%Sergents d'armes commandés par %THIS%: + %CHARGE%"},    
