...
class Unite {
    ...
    static pgs() { return [
        ...
        {nom:"Ambroise de Loré",pdf:true,niv:1,faction:FRANCAIS,type:CAVALERIE,melee:[rouge],defense:[noir],charge:true,pdv:2,maj:4,commandement:[AA,1],dates:[1410,1446],source:"https://fr.wikipedia.org/wiki/Ambroise_de_Lor%C3%A9",blason:true,cout:270,moral:3,desc:"%ACTIVATED%%ROUNDCOND%: +1 %VERT%"},
        {nom:"Ambroise de Loré",pdf:true,niv:2,faction:FRANCAIS,type:CAVALERIE,melee:[rouge,rouge],defense:[noir],pdv:3,charge:true,commandement:[AA,1],dates:[1410,1446],source:"https://fr.wikipedia.org/wiki/Ambroise_de_Lor%C3%A9",blason:true,moral:3,desc:"%ACTIVATED%%ROUNDCOND%: +1 %VERT%"},
        {nom:"Edmond de Somerset",niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune],defense:[rouge],riposte:ftrue,charisme:true,pdv:3,maj:4,commandement:[1,1],dates:[1420,1455],source:"https://fr.wikipedia.org/wiki/Edmond_Beaufort_(1er_duc_de_Somerset)",blason:true,enleve1d:true},
