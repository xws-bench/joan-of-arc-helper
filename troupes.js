...
const NOM_CAPACITE=["ignifugé",null,null,null,null,null,null,null,null,null,null,"grand","soin","soin <span class='bien combat-cond'></span> <span class='hereandthere combat-cond'></span>","cruel","relance","garde du corps","pourfendeur","charge",null,"prière",null,null,"esquive",null,"feinte","charisme","ralliement","impétueux","survie","génie","parade","immortel","mercenaire","visée","masse","cohésion","transport",null,"immunisé aux ripostes",null,"immunisé à la terreur",null,null,null,null,"légendaire"];
...
class Unite {
    static tps() { return [
        ...
        {nom:"Arbalétriers Génois",typetir:TENDU,portee:1,tir:[rouge],defense:[noir],type:INFANTERIE,cout:80,moral:1,desc:"%ACTIVATEDBE%: %THIS% peut être remplacée par les Arbalétriers Génois retranchés"},
        ...
        {nom:"Archers montés",melee:[noir],defense:[noir],type:CAVALERIE,celerite:2, desc:"au début ou à la fin de leur activation: %THIS% peuvent être remplacés par des Archers",cout:130,moral:1},
        {nom:"Archers",tir:[jaune_boucliertouche,jaune_boucliertouche],defense:[blanc],type:INFANTERIE,typetir:CLOCHE,portee:2,desc:"%STARTGAME%: recevez une haie de pieux%BR%Vous pouvez placer 1 haie de pieux dans la zone de %THIS% pour une action bonus",cout:125,moral:1},
        {nom:"Bourreau",melee:[jaune],defense:[blanc],type:INFANTERIE,desc:"%MELEE%, Inquisiteur%HEREANDTHERE%: <span class='facejaune vierge'></span> &rarr; <span class='facejaune tue'></span>, %MELEE%, 1 %LEGENDE%: relancez 1 <span class='dejaune'></span>"},
        ...
        {nom:"Fantômes",type:INFANTERIE,melee:[blanc,blanc,blanc],defense:[blanc,blanc,blanc],immortel:true,faction:MAL,desc:"%ACTIVATED% %ACTIVATED%%TOURCOND% %LEGENDE%: + %SAUT% 2%BR%%THIS% n'est pas affectée par les effets de terrain"},
        ...
        {nom:"Janissaires",melee:[noir],defense:[blanc],charge:true,masse:true,faction:OTTOMAN,type:INFANTERIE,desc:"%MELEE% %XP%: <span class='facenoir bouclier'></span> &rarr; <span class='touche facenoir'></span>"},
        ...
        {nom:"Paysans",melee:[jaune], defense:[],type:INFANTERIE,cohesion:true,desc:"%SPECIAL%: -1 %INCENDIE%%HEREANDTHERE%",moral:1,cout:20},
        ...
        {nom:"Prêtre",civil:true,type:INFANTERIE,priere:true,soinbienthere:true,commandement:[1,2],faction:BIEN},
        ...
        {nom:"Rebouteuse",civil:true,type:INFANTERIE,desc:"%CAMP%, %REROLL% une fois le dé du Destin pour deux unités alliés Hors de combat"},
    ];
                 }
    ...
    static pgs() { return [
        ...
        {nom:"Jeanne d'Arc",niv:2,subfaction:BIEN,faction:FRANCAIS,type:INFANTERIE,melee:[blanc,jaune],defense:[noir,noir],pdv:3,commandement:[3,2],survie:true,priere:true,terreur:1,dates:[1428,1431],source:"https://fr.wikipedia.org/wiki/Jeanne_d%27Arc",blason:true,moral:5,desc:"%ACTIVATEDE%%ROUNDCOND%: jouez %JAUNE% depuis la réserve commune dans la zone sitée jusqu'à 3 zones de distance de %THIS%%BR%%CAMP%: %RETARDE% &rarr; %RALLIE%"},
        {nom:"Jeanne d'Arc",niv:2,subfaction:MAL,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[rouge,jaune],pdv:4,commandement:[2,2],terreur:2,riposte:ftrue,dates:[1428,1431],source:"https://fr.wikipedia.org/wiki/Jeanne_d%27Arc",blason:true,moral:5,desc:"%ACTIVATEDE%%ROUNDCOND%: jouez un %JAUNE%  depuis la réserve commune dans la zone sitée jusqu'à 3 zones de distance de %THIS%%BR%%ROUND%: +1 %LEGENDE%, +1 %CARTELEGENDE%"},
        ...
        {nom:"Boucicaut",niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[noir,noir],pdv:3,ralliement:true,commandement:[2,2],maj:4,modattaque:annule2recul,dates:[1340,1415],source:"https://fr.wikipedia.org/wiki/Jean_II_Le_Meingre",blason:true,moral:5,cout:405,desc:"%ACTIVATED%%ROUNDCOND% %XP%%XP%%XP%: +1 %JAUNE%"},
        ...
        {nom:"Jean de Dunois",niv:2,subfaction:BIEN,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,jaune,noir],defense:[noir,noir],pdv:3,relance:true,survie:true,commandement:[1,2],dates:[1422,1468],source:"https://fr.wikipedia.org/wiki/Jean_de_Dunois",blason:true,moral:5,desc:"%ACTIVATED%%ROUNDCOND% %LEGENDE%: %GRIS% &rarr; %BLEU%%BR%%ACTIVATED%%ROUNDCOND%: %MOVE% 1 %RALLIEMENT%"},
        ...
        {nom:"Amaury de Craon",niv:2,faction:FRANCAIS,type:CAVALERIE,melee:[rouge,rouge],defense:[noir,noir],pdv:2,commandement:[AA,2],dates:[1345,1373],source:"https://fr.wikipedia.org/wiki/Amaury_IV_de_Craon",blason:true,cout:280,moral:3,desc:"%ACTIVATEDBE%%ROUNDCOND%: %MOVE% %THIS% de 2 zones"},    
        {nom:"Amaury de Craon",niv:1,faction:FRANCAIS,type:CAVALERIE,melee:[rouge],defense:[noir,noir],pdv:2,commandement:[AA,1],maj:3,dates:[1345,1373],source:"https://fr.wikipedia.org/wiki/Amaury_IV_de_Craon",blason:true,desc:"%ACTIVATEDBE%%TOURCOND%: %MOVE% %THIS%"},    
        ...
        {nom:"Arthur de Richemont",niv:1,faction:FRANCAIS,type:CAVALERIE,melee:[rouge,jaune],pdv:2,priere:true,cruel:true,commandement:[AA,2],maj:5,dates:[1414,1458],source:"https://fr.wikipedia.org/wiki/Arthur_III_de_Bretagne",blason:true,desc:"%ACTIVATEDBE%%TOURCOND% %LEGENDE%: %MOVE% %THIS%%BR%%TOUTTYPE%%HERE%: - Impetueux"},
        ...
        {nom:"Gilles de Rais",niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,rouge,jaune],defense:[noir],charisme:true,pdv:3,maj:4,dates:[1420,1436],source:"https://fr.wikipedia.org/wiki/Gilles_de_Rais",blason:true,moral:4,cout:305,desc:"%ACTIVATED%%TOURCOND% %XP%: %RALLIE%<span class='troupe combat-cond'></span>%HERE%%BR%%MELEE%: 1+ <span class='facerouge vierge'></span> / <span class='facejaune vierge'></span> &rarr; %REROLL% 1 <span class='derouge'></span> / <span class='dejaune'></span>"},
        {nom:"Gilles de Rais",niv:2,subfaction:BIEN,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,rouge,jaune,jaune],defense:[noir,jaune],pdv:3,charisme:true,pourfendeur:true,commandement:[1,1],dates:[1420,1436],source:"https://fr.wikipedia.org/wiki/Gilles_de_Rais",blason:true,moral:4,desc:"%ACTIVATEDB%: %MOVE% %RALLIEMENT%%BR%%MELEE%: 1+ <span class='facerouge vierge'></span> / <span class='facejaune vierge'></span> &rarr; %REROLL% 1 <span class='derouge'></span> / <span class='dejaune'></span>"},
        ...
        {nom:"Edouard d'York",niv:2,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune,jaune],defense:[noir,rouge],cruel:true,charge:true,gardeducorps:true,pdv:3,commandement:[2,3],dates:[1401,1415],source:"https://fr.wikipedia.org/wiki/%C3%89douard_de_Norwich",blason:true,desc:"%DEFENSE%: %TOUCHE% &rarr; %RECUL%%BR%%MONTOUR%: +1 %LEGENDE%"},
        ...
        {nom:"Jean de Lancastre",niv:2,subfaction:MAL,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune,jaune],defense:[noir,noir],pdv:2,ralliement:true,modattaque:annule1touche,riposte:ftrue,commandement:[1,2],dates:[1403,1435],source:"https://fr.wikipedia.org/wiki/Jean_de_Lancastre",blason:true,moral:3,desc:"%MELEE%: <span class='facenoir vierge'></span> / <span class='facejaune vierge'></span> &rarr; %LEGENDE%"},
        ...
        {nom:"Comte de Suffolk",niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[blanc,blanc],ralliement:true,pdv:2,maj:3,commandement:[AA,1],dates:[1337,1369],source:"https://fr.wikipedia.org/wiki/Robert_d%27Ufford",blason:true,cout:260,moral:3, desc:"%ACTIVATED%%TOURCOND% %XP%: %RALLIE% %TROUPE%%HERE%"},
        {nom:"Comte de Suffolk",niv:2,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,rouge],defense:[blanc,blanc],survie:true,pdv:2,commandement:[1,2],dates:[1337,1369],source:"https://fr.wikipedia.org/wiki/Robert_d%27Ufford", blason:"images/armoiries_Suffolk.png",moral:3,desc:"%TROUPE%%HERE%: + %COHESION%"},
        ...
        {nom:"William de la Pôle",niv:1,faction:ANGLAIS,type:CAVALERIE,melee:[rouge,jaune],defense:[noir],charge:true,maj:3,commandement:[AA,1],dates:[1415,1450],source:"https://fr.wikipedia.org/wiki/William_de_la_Pole",blason:true,desc:"%DEFENSE%: %TOUCHE% &rarr; %RECUL%"},
        ...
        {nom:"La Grande Faucheuse",faction:MERCENAIRE,type:VOLANT,defense:[noir,rouge,rouge],pdv:4,immortel:true,riposte:ftrue,commandement:[3,2],desc:"%TOUTTYPE%%HERE%: %MORT% &rarr; %LEGENDE% / %XP%%BR%%CAMP%, %XP%, %TOUCHE% &rarr; %MORT%"},    
        ...
        {nom:"John Chandos",niv:2,subfaction:BIEN,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,noir],defense:[rouge,rouge,rouge],pdv:3,riposte:ftrue,survie:true,commandement:[1,2],dates:[1339,1370],source:"https://fr.wikipedia.org/wiki/John_Chandos",blason:true,moral:3,desc:"%CONSEIL%: +1 %GRIS% %XP%"},    
        {nom:"John Chandos",niv:2,subfaction:MAL,faction:ANGLAIS,type:INFANTERIE,melee:[noir,noir,noir],defense:[noir],pdv:4,pourfendeur:true,gardeducorps:true,commandement:[AA,3],dates:[1339,1370],source:"https://fr.wikipedia.org/wiki/John_Chandos",blason:true,moral:3,desc:"%MONTOUR%: +1 %GRIS%%BR%%MELEE%: 1 <span class='facenoir touche'></span> &rarr; 1 <span class='facenoir tue'></span>"},
        ...
        {nom:"Jean Stuart de Derneley",niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,blanc],defense:[noir],pdv:2,charge:true,feinte:true,maj:2,commandement:[AA,1],dates:[1421,1429],source:"https://fr.wikipedia.org/wiki/John_Stuart_de_Darnley",blason:true,cout:320,moral:4,desc:"Archers Archers%HERE%: %TIRCLOCHE% +1 <span class='dejaune'></span>"},    
        {nom:"Jean Stuart de Derneley",niv:2,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,rouge],defense:[noir],pdv:2,genie:true,charge:true,ralliement:true,modattaque:annule1recul,commandement:[1,2],dates:[1421,1429],source:"https://fr.wikipedia.org/wiki/John_Stuart_de_Darnley",blason:true,moral:4,desc:"Archiers Archers%HERE%: %TIRCLOCHE% +1 <span class='dejaune'></span>"},    
        ...
        {nom:"Jean Stuart de Buchan",niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,rouge],defense:[noir],pdv:2,charge:true,impetueux:true,modattaque:annule1recul,maj:4,dates:[1404,1424],source:"https://fr.wikipedia.org/wiki/John_Stuart_(3e_comte_de_Buchan)",blason:true,cout:300,moral:3},    
        {nom:"Jean Stuart de Buchan",niv:2,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,rouge,jaune],defense:[noir],pdv:2,charge:true,impetueux:true,modattaque:annule2recul,commandement:[AA,3],dates:[1404,1424],source:"https://fr.wikipedia.org/wiki/John_Stuart_(3e_comte_de_Buchan)",blason:true,moral:3,desc:"%ACTIVATED%%ROUNDCOND%: %ROLL% <span class='denoir'></span>, <span class='facenoir touche'></span> &rarr; %GRIS%"},    
        ...
        {nom:"Mehmet II",niv:1,faction:OTTOMAN,type:INFANTERIE,melee:[noir],defense:[noir],charisme:true,priere:true,ralliement:true,pdv:2,commandement:[1,2],maj:4,dates:[1444,1481],source:"https://fr.wikipedia.org/wiki/Mehmed_II",desc:"%ACTIVATED%%ROUNDCOND% %LEGENDE%: +1 %CARTELEGENDE%%BR%%ACTIVATED%%ROUNDCOND% %XP%: %LEGENDE%"},
        {nom:"Mehmet II",niv:2,faction:OTTOMAN,type:INFANTERIE,melee:[rouge],defense:[noir,blanc],charisme:true,priere:true,ralliement:true,pdv:2,commandement:[1,3],dates:[1444,1481],source:"https://fr.wikipedia.org/wiki/Mehmed_II",desc:"%BLEU%%ROUNDCOND%: vous pouvez jouer  %BLEU% à la suite%BR%%XP%%ACTIVATED%%ROUNDCOND%: +1 %GRIS%"},
        ...
        {nom:"Vlad Tepes",niv:1,faction:VALAQUE,type:INFANTERIE,melee:[rouge],defense:[rouge,noir],celerite:2,riposte:ftrue,terreur:1,pdv:2,commandement:[2,1],modattaque:annule2recul,maj:4,dates:[1448,1476],source:"https://fr.wikipedia.org/wiki/Vlad_III_l%27Empaleur",desc:"%ACTIVATED%%ROUNDCOND% %XP%: %MOVE% 1 %RALLIEMENT%"},
        {nom:"Vlad Tepes",niv:2,faction:VALAQUE,type:INFANTERIE,melee:[rouge,rouge],defense:[noir,noir],celerite:2,terreur:2,pdv:3,commandement:[3,2],dates:[1448,1476],source:"https://fr.wikipedia.org/wiki/Vlad_III_l%27Empaleur",desc:"%MELEE% %LEGENDE%: <span class='facerouge bouclier'></span> &rarr; <span class='facerouge tue'></span>%BR%%ACTIVATED%%TOURCOND% %XP%: %MOVE% 1 %RALLIEMENT%"},
        ...
        {nom:"La Tarasque",niv:2,faction:MAL,type:INFANTERIE,melee:[rouge,rouge,rouge],defense:[noir,noir],pdv:10,grand:true,terreur:1,dates:[1382,1382],source:"https://fr.wikipedia.org/wiki/Tarasque",desc:"%MELEE%: %BLESSURE% &rarr; +1 %BLESSURE%"},
        ...
        {nom:"Dracula",niv:1,faction:MAL,type:INFANTERIE,melee:[rouge,rouge],defense:[rouge,noir],pdv:3,saut:2,terreur:1,commandement:[2,1],maj:5,desc:"%LEGENDE% %ACTIVATED%%ROUNDCOND%: + <span class='commandement'>&nbsp;&nbsp;&nbsp; 1</span>%BR%+1 %BLESSURE% &rarr; %LEGENDE% / %XP%"},
        ...
        {nom:"Sainte Marthe",niv:1,faction:BIEN,type:INFANTERIE,melee:[jaune],defense:[noir],priere:true,maj:5,noterreur:true,desc:"%DEFENSE%: %TUE% / %TOUCHE% &rarr; %RECUL%"},
        {nom:"Sainte Marthe",niv:2,faction:BIEN,type:INFANTERIE,melee:[jaune,jaune,jaune],defense:[noir],pdv:2,priere:true,terreur:2,noterreur:true,desc:"%DEFENSE%: %TUE% / %TOUCHE% &rarr; %RECUL%"},
    ];}
        ...
        if (typeof this.desc!="undefined") {
            dd=this.desc.replace(/%LEGENDE%/g,"<span class='jetonlegende jeton'></span>")
               ...
               .replace(/%TUE%/g,"<span class='tue'></span>")
                ...
                .replace(/%ACTIVATEDB%/g,"<b>action début activation</b>")
                .replace(/%ACTIVATEDE%/g,"<b>action fin activation</b>")
                .replace(/%ACTIVATEDBE%/g,"<b>action activation</b>")
