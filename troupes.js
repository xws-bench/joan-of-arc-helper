...
class Unite {
    ...
    static pgs() { return [
        ...
        {nom:"Arbre Sacré",pdf:true,faction:LITUANIEN,type:INFANTERIE,melee:[rouge,rouge,blanc],defense:[noir],pdv:4,grand:true,terreur:1,noriposte:true,desc:"Si %THIS% est située dans une zone de forêt, elle peut déclarer une attaque de mélée depuis n'importe quelle autre zone de forêt contenant un arbre. Retirez ensuite cet arbre du jeu."},
        {nom:"Perkunas",pdf:true,niv:1,maj:5,faction:LITUANIEN,type:VOLANT,melee:[rouge,noir],tir:[blanc,blanc],portee:2,typetir:TENDU,commandement:[1,1],defense:[unbouclier,unbouclier],pdv:3,grand:true,terreur:1,saut:2,desc:"Il est impossible de se défendre contre une attaque de tir de Perkunas."},
        {nom:"Perkunas",pdf:true,niv:2,faction:LITUANIEN,type:VOLANT,melee:[rouge,noir],commandement:[2,1],defense:[unbouclier,unbouclier],pdv:4,grand:true,terreur:3,saut:3,immortel:true,ignifuge:true},
        ...
        {nom:"Héros Lituanien",pdf:true,niv:2,faction:LITUANIEN,subfaction:BIEN,type:INFANTERIE,melee:[blanc,blanc],commandement:[1,1],defense:[noir],ralliement:true,parade:true,pdv:2,desc:"<span class='foret combat'></span>%HERE% : + <span class='commandement'>&nbsp;&nbsp;&nbsp; 1</span>"},
        {nom:"Héros Lituanien",pdf:true,niv:2,faction:LITUANIEN,subfaction:MAL,type:INFANTERIE,melee:[rouge,blanc,blanc],commandement:[1,1],defense:[blanc,rouge],feinte:ftrue,parade:true,pdv:2,desc:"%MELEE%%FORET%: %RECUL% &rarr; %TOUCHE%"},
        {nom:"Roi Casimir IV de Lituanie",pdf:true,niv:1,maj:5,faction:LITUANIEN,type:CAVALERIE,melee:[rouge,rouge],commandement:[1,1],defense:[noir,blanc],charge:true,feinte:ftrue,parade:true,riposte:ftrue,pdv:3,desc:"%DEFENSE%, %THIS% seul dans sa zone: 1 %TOUCHE &rarr; 1 %RECUL%"},
        {nom:"Roi Casimir IV de Lituanie",pdf:true,niv:2,faction:LITUANIEN,type:CAVALERIE,melee:[rouge,rouge],commandement:[1,2],defense:[noir,blanc],charge:true,feinte:ftrue,parade:true,riposte:ftrue,pdv:4,desc:"%DEFENSE%, %THIS% seul dans sa zone: 2 %TOUCHE &rarr; 2 %RECUL%"},
        {nom:"Narimantas",pdf:true,niv:1,maj:4,faction:LITUANIEN,type:CAVALERIE,melee:[rouge,rouge],commandement:[1,1],defense:[noir],charge:true,gardeducorps:true,pdv:2,desc:"%DEFENSE%: pour chaque résultat alloué à %THIS%, infligez 1 %RECUL% en tant que riposte à la zone attaquante."},
        {nom:"Narimantas",pdf:true,niv:2,faction:LITUANIEN,type:CAVALERIE,melee:[rouge,rouge],commandement:[2,1],defense:[noir],charge:true,gardeducorps:true,visee:true,pdv:3,desc:"%DEFENSE%: pour chaque résultat alloué à %THIS%, infligez 1 %RECUL% en tant que riposte à la zone attaquante."},
        {nom:"Héros Teutonique",pdf:true,niv:1,maj:3,faction:TEUTONIQUE,type:INFANTERIE,melee:[noir],commandement:[AA,1],defense:[noir],charge:true,impetueux:true,priere:true,desc:"%MELEE%: pour chaque résultat %TUE% obtenu, lancez 1 <span class='denoir'></span>. Ce dé dispose du même effet"},
        {nom:"Héros Teutonique",pdf:true,niv:2,faction:TEUTONIQUE,type:INFANTERIE,melee:[noir],commandement:[1,1],defense:[noir],charge:true,impetueux:true,feinte:true,pdv:2,desc:"%MELEE%: pour chaque résultat %TUE% obtenu, lancez 1 <span class='denoir'></span>. Ce dé dispose du même effet"},
        {nom:"Winrich von Kniprod",pdf:true,niv:1,maj:4,faction:TEUTONIQUE,type:CAVALERIE,melee:[rouge,blanc,jaune],commandement:[1,1],defense:[blanc],charge:true,pdv:2,desc:"%MELEE%: si %THIS% obtient au moins 2 %TOUCHE%, l'attaque de %THIS% ne peut pas être bloquée par des résultats %BOUCLIER%"},
        {nom:"Winrich von Kniprod",pdf:true,niv:2,faction:TEUTONIQUE,type:CAVALERIE,melee:[rouge,blanc,blanc],commandement:[1,1],defense:[noir,blanc],charge:true,feinte:true,pdv:3,desc:"%MELEE%: si %THIS% obtient au moins 2 %TOUCHE%, l'attaque de %THIS% ne peut pas être bloquée par des résultats %BOUCLIER%"},
        {nom:"Manvydas",pdf:true,niv:1,faction:TEUTONIQUE,type:INFANTERIE,melee:[blanc,blanc],tir:[jaune,jaune],portee:1,typetir:TENDU,commandement:[AA,1],defense:[blanc],celerite:2,desc:"%MELEE%%FORET%: %TOUCHE% &rarr; +1 %RECUL%"},
        {nom:"Bernard Szumborski",pdf:true,faction:TEUTONIQUE,type:INFANTERIE,melee:[rouge,blanc],commandement:[1,2],defense:[noir],feinte:true,pdv:3,desc:"%SPECIAL%: %THIS% peut déclarer une attaque contre une unité adjacente. Seul de jet d'attaque de %THIS% et le jet de défense de l'unité ciblée sont résolus."},
        {nom:"Héros Teutonique Monté",pdf:true,niv:1,maj:3,faction:TEUTONIQUE,type:CAVALERIE,melee:[rouge,blanc,noir],commandement:[1,1],defense:[noir],charge:true,impetueux:true,priere:true,pdv:2},
        {nom:"Héros Teutonique Monté",pdf:true,niv:2,faction:TEUTONIQUE,type:CAVALERIE,melee:[rouge,blanc,noir],commandement:[2,1],defense:[noir],charge:true,parade:true,priere:true,pdv:3},
        {nom:"Héros Polonais Monté",pdf:true,niv:1,maj:4,faction:POLONAIS,type:CAVALERIE,melee:[rouge,noir],commandement:[AA,1],defense:[noir],charge:true,pdv:2,desc:"%MELEE%%VERT%: +1 <span class='denoir'></span>"},
        {nom:"Héros Polonais Monté",pdf:true,niv:2,faction:POLONAIS,type:CAVALERIE,melee:[rouge,noir],commandement:[1,1],defense:[noir],charge:true,pdv:3,desc:"%MELEE%%VERT%: +1 <span class='derouge'></span>, -1 %BOUCLIER% du jet de défense de votre adversaire"},
    ];}
        ...
        if (typeof this.desc!="undefined") {
            dd=this.desc.replace(/%LEGENDE%/g,"<span class='jetonlegende jeton'></span>")
               ...
               .replace(/%TUE%/g,"<span class='tue'></span>")
                ...
                .replace(/%GARDEDUCORPS%/g,"Garde du corps")
