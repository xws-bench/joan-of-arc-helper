...
class Unite {
    ...
    static pgs() { return [
        ...
        {nom:"Jacques de Bourbon",niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge],defense:[noir],pdv:2,maj:4,commandement:[AA,2],dates:[1342,1362,1393,1438],source:"https://fr.wikipedia.org/wiki/Jacques_Ier_de_Bourbon-La_Marche https://fr.wikipedia.org/wiki/Jacques_II_de_Bourbon",blason:true},
