...
class Unite {
    static tps() { return [
        ...
        {nom:"Arbalétriers Génois",pdf:true,prenom:"Retranchés",typetir:TENDU,portee:1,tir:[rouge,blanc],defense:[noir,blanc],type:INFANTERIE,recultue:true,desc:"%THIS% ne peut pas se déplacer%BR%%DEFENSE%: <span class='recul'></span> &rarr; <span class='mort'></span>"},
        ...
        {nom:"Chevaliers squelettes",melee:[rouge,blanc],defense:[blanc],charge:true,type:CAVALERIE,survie:true,masse:true,faction:MAL,modattaque:annule1recul},
        ...
        {nom:"Chevaliers squelettes",m2:[160,2,CAVAL,0,0,0,4],melee:[rouge,blanc],defense:[blanc],type:CAVALERIE,modattaque:annule1recul,faction:MAL},
        ...
        {nom:"Fantômes",m2:[160,1,FANTASSINS,0,0,0,2],pdf:true,type:INFANTERIE,melee:[blanc,blanc,blanc],defense:[blanc,blanc,blanc],immortel:true,faction:MAL,desc:"%ACTIVATED%%TOURCOND% %LEGENDE%: + %SAUT% 2%BR%%THIS% n'est pas affectée par les effets de terrain"},
        ...
        {nom:"Hacquebutiers",s3:[100,1,ARCHERS,0,0,0,2],tir:[jaune_blanctue],defense:[noir],type:INFANTERIE,terreur:1,typetir:TENDU,portee:1,cout:100},
        ...
        {nom:"Milice Paysanne",f1:[25,1,MILICE,0,6],f2:[25,1,PAYSANS,3,6],pdf:true,melee:[blanc], defense:[],type:INFANTERIE,masse:true,desc:"%MELEE%%CHAMP%: + %FEINTE%",cout:25},
        ...
        {nom:"Sapeurs",s1:[120,1,SAPEURS,0,0,0,3],melee:[blanc],defense:[blanc],genie:true,type:INFANTERIE,cout:120},
        ...
        {nom:"Bombarde",s2:[260,3,BOMBARDE,0,0,0,2],s1:[220,3,BOMBARDE,0,0,0,1],tir: [rouge,rouge,blanc_blanctue],defense:[blanc],type:ARTILLERIE,typetir:CLOCHE,portee:2,pdv:2},
        {nom:"Couleuvrine",f3:[130,1,CANON,0,0,0,1],s1:[140,2,CANON,0,0,0,2],s2:[160,2,CANON,0,0,0,3],pdf:true,tir:[jaune_blancrecule,jaune_blancrecule,jaune_blancrecule],defense:[noir],visee:true,typetir:TENDU,portee:2,type:ARTILLERIE,cout:155,moral:2},
        {nom:"Baliste",s2:[120,2,CANON,0,0,1,1],tir:[noir_boucliertouche],defense:[blanc],type:ARTILLERIE,typetir:TENDU,portee:3,pdv:2,visee:true},
        {nom:"Echelles",type:ARTILLERIE,s1:[20,0,TOURDESIEGE,0,0,2,4]},
        {nom:"Trébuchet",s1:[150,2,BOMBARDE,0,0,0,2],tir:[blanc_blanctue,blanc_blanctue],defense:[blanc],type:ARTILLERIE,typetir:CLOCHE,visee:true,grand:true,pdv:2,portee:3,moral:2,cout:150},
        {nom:"Tour de Siège",s1:[260,4,TOURDESIEGE,0,0,0,1],defense:[blanc,blanc],ralliement:true,grand:true,type:ARTILLERIE,pdv:8},
        {nom:"Bélier",s1:[100,3,TOURDESIEGE,0,0,0,1],defense:[noir,noir],pdv:4,type:ARTILLERIE,cout:100,moral:3},
        ...
        {nom:"Pavois",s1:[100,1,PAVOIS,0,0,2,2],defense:[noir,blanc],pdv:4,type:INFANTERIE,cout:100,desc:"%DEFENSE%: %TUE%%HERE%, %TOUCHE%%HERE% peuvent être alloués à %THIS%"},
    ...
    static pgs() { return [
        ...
        {nom:"Philippe le Hardi",f:'A',f2:[225,3,SOUTIEN,0,1],pdf:true,faction:FRANCAIS,type:INFANTERIE,defense:[noir,blanc],charge:true,parade:ftrue,feinte:true,dates:[1352,1404],source:"https://fr.wikipedia.org/wiki/Philippe_II_de_Bourgogne",blason:true,cout:225,moral:3 , desc:"%PERSONNAGE%%HERE% : + %PARADE%%BR%Les unités dans sa zone ne peuvent subir d'attaque de tir"},
        ...
        {nom:"Héros",niv:1,f:'D',b2:[170,3,PERSONNAGE,1,2],b1:[150,3,PERSONNAGE,1,2],b2:[160,3,PERSONNAGE,1,2],f1:[170,3,PERSONNAGE,1,2],f3:[160,3,PERSONNAGE,1,2],f2:[160,3,SOUTIEN,0,1],faction:FRANCAIS,type:INFANTERIE,melee:[rouge],defense:[noir],priere:true,feinte:true,commandement:[AA,1],maj:3,cout:160,moral:3},
        ...
        {nom:"Héros",f:'D',a1:[160,3,PERSONNAGE,1,2],a2:[170,3,PERSONNAGE,1,2],niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge],defense:[noir],priere:true,feinte:true,commandement:[AA,1],maj:3,moral:3,cout:160},
        ...
        {nom:"Barral de Pontevès",f:'A',f3:[240,4,SOUTIEN,0,1],pdf:true,niv:2,subfaction:BIEN,faction:FRANCAIS,type:CAVALERIE,melee:[rouge,rouge],defense:[noir,blanc],charge:true,feinte:true,pourfendeur:true,pdv:3,commandement:[AA,2],dates:[1370,1390],source:"https://fr.wikipedia.org/wiki/Pontev%C3%A8s#Moyen_%C3%82ge",moral:4},    
        ...
        {nom:"Guillaume de Molins",f:'B',a3:[180,3,PERSONNAGE,1,2],niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge],defense:[noir],priere:true,feinte:true,pdv:2,maj:3,commandement:[AA,1],dates:[1429,1429],source:"https://www.persee.fr/docAsPDF/bec_0373-6237_1847_num_8_1_452089.pdf"},
        ...
        {nom:"John Talbot",f:'CSY',a3:[330,3,PERSONNAGE,1,2],pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,noir],defense:[noir],charge:true,feinte:true,pdv:2,commandement:[1,1],maj:3,dates:[1404,1453],source:"https://fr.wikipedia.org/wiki/John_Talbot_(1er_comte_de_Shrewsbury)",blason:true,cout:330,moral:3,desc:"%TROUPE%%HERE%: + %CHARGE%"},
        ...
        {nom:"Jean Stuart de Derneley",f:'JSD',e1:[320,4,PERSONNAGE,1,2],pdf:true,niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[noir,noir],defense:[noir],pdv:2,impetueux:true,charge:true,feinte:true,maj:2,commandement:[AA,1],dates:[1421,1429],source:"https://fr.wikipedia.org/wiki/John_Stuart_de_Darnley",blason:true,cout:320,moral:4,desc:"%MELEE%: %MORT% &rarr; reprenez le jeton de relance si vous ne l'avez plus"},
        ...
        {nom:"Jean Stuart de Buchan",f:'B',e1:[300,3,PERSONNAGE,1,2],pdf:true,niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,blanc],defense:[noir],commandement:[AA,1],pdv:2,feinte:true,charge:true,maj:4,dates:[1404,1424],source:"https://fr.wikipedia.org/wiki/John_Stuart_(3e_comte_de_Buchan)",blason:true,cout:300,moral:3,desc:"%TROUPE%%TROUPE%<span class='combat-cond tirtendu'></span><span class='combat-cond tircloche'></span>%HERE%: +1 <span class='dejaune'></span>"},    
