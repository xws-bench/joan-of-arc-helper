...
class Unite {
    ...
    static pgs() { return [
        ...
        {nom:"Jeanne d'Arc",f3:[325,5,PERSONNAGE,1,2],f:"JJ",pdf:true,acheval:true,niv:1,faction:FRANCAIS,type:CAVALERIE,defense:[blanc],pdv:2,celerite:2,priere:true,parade:ftrue,commandement:[AA,2],maj:4,dates:[1428,1431],source:"https://fr.wikipedia.org/wiki/Jeanne_d%27Arc",blason:true,desc:"%ACTIVATED%%ROUNDCOND%: +1 %JAUNE%"},
        ...
        {nom:"Comte d'Arundel",f:'CAR',a1:[265,3,PERSONNAGE,1,2],pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge],defense:[noir,jaune],riposte:ftrue,pdv:2,maj:3,commandement:[1,1],dates:[1313,1376,1426,1430],source:"https://fr.wikipedia.org/wiki/Richard_FitzAlan_(3e_comte_d%27Arundel) https://fr.wikipedia.org/wiki/John_FitzAlan_(7e_comte_d%27Arundel)",blason:true,desc:"%SPECIAL%%TOURCOND%: %MOVE% %THIS% %HEREANDTHEREHEXA%"},
        ...
        {nom:"Manvydas",pdf:true,v15:true,niv:1,faction:LITUANIEN,type:INFANTERIE,melee:[blanc,blanc],tir:[jaune,jaune],portee:1,typetir:TENDU,commandement:[AA,1],defense:[blanc],celerite:2,desc:"%MELEE%%FORET%: %TOUCHE% &rarr; +1 %RECUL%"},
