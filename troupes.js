...
class Unite {
    ...
    static replaceMd(dd) {
        return dd.replace(/%LEGENDE%/g,"<span class='jetonlegende jeton'></span>")
            ...
            .replace(/%VALAQUE%/g,"<span class='blason-large valaque'></span>")
            .replace(/%MERCENAIRE%/g,"<span class='blason-large mercenaire'></span>")
            .replace(/%BOURGUIGNON%/g,"<span class='blason-large bourguignon'></span>")
            .replace(/%POLONAIS%/g,"<span class='blason-large polonais'></span>")
            .replace(/%LITUANIEN%/g,"<span class='blason-large lituanien'></span>")
            .replace(/%TEUTONIQUE%/g,"<span class='blason-large teutonique'></span>")
            .replace(/%OTTOMAN%/g,"<span class='blason-large ottoman'></span>")
            .replace(/%MAL%/g,"<span class='blason-large mal'></span>")
            .replace(/%BIEN%/g,"<span class='blason-large bien'></span>")
            .replace(/%NEUTRE%/g,"<span class='blason-large neutre'></span>")
    ...
    toHTML() {
        ...
        if (typeof this.desc!="undefined") {
            ...
            dd=dd.replace(/%MELEE%/g,attaque.join(' / '))
