...
class Unite {
    static tps() { return [
        ...
        {nom:"Adeptes",pdf:true,melee:[rouge],defense:[noir],type:INFANTERIE,faction:MAL,desc:"quand ils sont dans une zone de marais, %THIS% ignorent les effets de terrain liés aux marais et peuvent réaliser un mouvement vers n'importe quelle autre zone de marais du plateau de jeu"},
        {nom:"Almograves",pdf:true,melee:[blanc],defense:[jaune],type:INFANTERIE,esquive:true,noriposte:true,moral:1,cout:65},
        {nom:"Ange",pdf:true,melee:[rouge,blanc],bonusmelee:blancsimal,defense:[noir,noir],type:VOLANT,faction:BIEN,saut:2,transport:true,faction:BIEN,priere:true}, 
        {nom:"Arbalétriers Génois",pdf:true,prenom:"Retranchés",typetir:TENDU,portee:1,tir:[rouge,blanc],defense:[noir,blanc],type:INFANTERIE,recultue:true,moral:1,desc:"%THIS% ne peut pas se déplacer%BR%%DEFENSE%: <span class='recul'></span> &rarr; <span class='mort'></span>"},
        {nom:"Arbalétriers Génois",pdf:true,typetir:TENDU,portee:1,tir:[rouge],defense:[noir],type:INFANTERIE,cout:80,moral:1,desc:"%ACTIVATED%: en fin ou début d'activation, %THIS% peut être remplacée par les Arbalétriers Génois retranchés"},
        {nom:"Arbalétriers",pdf:true,typetir:TENDU,portee:1,tir:[rouge_bouclierrelance],defense:[blanc],type:INFANTERIE,cout:80,moral:1},
        {nom:"Archers Arc Court",pdf:true,tir:[noir, noir],defense:[blanc],type:INFANTERIE,typetir:TENDU,portee:1,desc:"pendant le tour adverse %ROUNDCOND%: +1 %TIRTENDU%",moral:1,cout:125},
        {nom:"Archers Azab",pdf:true,tir:[jaune,jaune],defense:[jaune],faction:OTTOMAN,type:INFANTERIE,typetir:TENDU,portee:1,esquive:true,celerite:2,desc:"%ACTIVATED%: %THIS% peut placer 1 haie de pieux issue de la réserve sur une frontière libre de sa zone"},
        ...
        {nom:"Archers montés",pdf:true,tir:[blanc,blanc],typetir:CLOCHE,portee:2,defense:[noir],type:CAVALERIE,celerite:2, cout:130,moral:1},
        {nom:"Archers",pdf:true,tir:[jaune_boucliertouche,jaune_boucliertouche],defense:[blanc],type:INFANTERIE,typetir:CLOCHE,portee:2,desc:"%ACTIVATED%: %THIS% peut placer 1 haie de pieux issue de la réserve sur une frontière libre de sa zone",cout:125,moral:1},
        {nom:"Bourreau",pdf:true,melee:[jaune_blanctue],defense:[blanc],type:INFANTERIE,desc:"%MELEE%, activé par commandement: +1 <span class='derouge'></span>"},
        ...
        {nom:"Cavaliers Nobles",pdf:true,type:CAVALERIE,melee:[rouge,blanc],defense:[blanc,rouge],faction:OTTOMAN,riposte:ftrue,charge:true,desc:"%DEFENSE%: <span class='recul'></span> &rarr; %CHOOSERECUL%"},
        {nom:"Cavaliers Sipahi",pdf:true,type:CAVALERIE,melee:[blanc_blanctue],defense:[blanc],faction:OTTOMAN,type:INFANTERIE,esquive:true,celerite:2,charge:true},
        {nom:"Chevaliers Impétueux",pdf:true,melee:[rouge,rouge],defense:[noir],riposte:ftrue,type:INFANTERIE,impetueux:true,modattaque:annule1recul,cout:140,moral:2},
        {nom:"Chevaliers montés",pdf:true,prenom:"Petite noblesse",type:CAVALERIE,melee:[rouge_bouclierrecule,noir_bouclierrecule],defense:[noir],charge:true,cout:135,moral:2},
        ...
        {nom:"Chevaliers montés",pdf:true,type:CAVALERIE,melee:[rouge,rouge],defense:[noir],charge:true},
        {nom:"Chevaliers à pied",pdf:true,prenom:"Armes à 2 mains",bonusmelee:rougesiinfanterie,melee:[rouge,rouge],defense:[noir],type:INFANTERIE,moral:2,cout:120},
        {nom:"Chevaliers à pied",pdf:true,melee:[rouge,rouge],defense:[noir],type:INFANTERIE,modattaque:annule1recul,cout:155,moral:2},
        {nom:"Chiens de Chasse",pdf:true,melee:[blanc,jaune],defense:[jaune],type:INFANTERIE,celerite:2,moral:1,cout:70},
        {nom:"Chiens de Guerre",pdf:true,melee:[rouge,blanc],defense:[jaune],celerite:2,type:INFANTERIE,gardeducorps:true,moral:1,cout:120},
        {nom:"Démons Voraces",pdf:true,melee:[rouge],defense:[blanc_blanctue,blanc_blanctue],contrecoup:ftrue,type:INFANTERIE,faction:MAL},
        {nom:"Démons Volants",pdf:true,tir:[rouge,jaune],defense:[noir],type:VOLANT,saut:2,immortel:true,typetir:TENDU,portee:1,faction:MAL,desc:"%MELEE%: <span class='vierge facejaune'></span> &rarr; %LEGENDE%"},
        {nom:"Fantômes",pdf:true,type:INFANTERIE,melee:[blanc,blanc,blanc],defense:[blanc,blanc,blanc],immortel:true,faction:MAL,desc:"%ACTIVATED%%TOURCOND% %LEGENDE%: + %SAUT% 2%BR%%THIS% n'est pas affectée par les effets de terrain"},
        {nom:"Flagellants",pdf:true,melee:[blanc],defense:[],type:INFANTERIE,survie:true,faction:BIEN,desc:"%MELEE% Pénitents%HERE%: +1 <span class='deblanc'></span>"},
        {nom:"Guisarmiers",pdf:true,melee:[blanc_blanctouche],defense:[blanc_parade],type:INFANTERIE,parade:ftrue,cohesion:true,moral:1,cout:75},
        {nom:"Hacquebutiers",tir:[jaune_blanctue],defense:[noir],type:INFANTERIE,terreur:1,typetir:TENDU,portee:1,cout:100,moral:1},
        {nom:"Hallebardiers",pdf:true,bonusmelee:blancsiinfanterie,melee:[blanc],defense:[rouge,blanc],type:INFANTERIE,riposte:ftrue,moral:2,cout:110},
        {nom:"Hérétiques",pdf:true,melee:[noir,jaune],defense:[jaune],type:INFANTERIE,cout:90,moral:1,desc:"%MELEE%<span class='niveau2 combat-cond'></span>: <span class='recul'></span> &rarr; <span class='niveau1 combat'></span>%BR%%DEFENSE%: <span class='facejaune vierge'></span> &rarr; %LEGENDE%"},
        {nom:"Infanterie légère",pdf:true,melee:[blanc],defense:[jaune],esquive:true,faction:OTTOMAN,type:INFANTERIE,celerite:2},
        {nom:"Janissaires",pdf:true,melee:[noir],defense:[blanc],esquive:true,charge:true,masse:true,faction:OTTOMAN,type:INFANTERIE,desc:"%MELEE% %XP%: <span class='facenoir bouclier'></span> &rarr; <span class='touche facenoir'></span>"},
        {nom:"Loups",pdf:true,melee:[blanc,jaune],defense:[jaune],celerite:2,type:INFANTERIE,esquive:true,faction:MAL},
        {nom:"Milice Bourgeoise",pdf:true,melee:[blanc], defense:[jaune],type:INFANTERIE,moral:1,cout:35},
        {nom:"Milice Paysanne",pdf:true,melee:[blanc], defense:[],type:INFANTERIE,masse:true,desc:"%MELEE%%CHAMP%: + %FEINTE%",cout:25,moral:1},
        {nom:"Milice d'Archers",pdf:true,tir:[noir],defense:[jaune],typetir:TENDU,portee:1,type:INFANTERIE,esquive:true,cout:65,moral:1},
        ...
        {nom:"Okchu",pdf:true,tir:[jaune_boucliertouche],defense:[jaune],type:INFANTERIE,faction:OTTOMAN,typetir:CLOCHE,portee:2,celerite:2},
        ...
        {nom:"Paysans",pdf:true,melee:[jaune], defense:[],type:INFANTERIE,masse:true,desc:"%SPECIAL%: -1 %INCENDIE%%HEREANDTHERE%",moral:1,cout:20},
        {nom:"Pestiférés",pdf:true,melee:[blanc],defense:[],type:INFANTERIE,masse:true,terreur:2,modattaque:annule1touche},
        {nom:"Piquiers Ecossais",pdf:true,melee:[blanc],defense:[jaune],contrecoup:sicavalerie,type:INFANTERIE,masse:true,faction:ECOSSAIS,cout:65,moral:1},
        {nom:"Piquiers Flamands",pdf:true,melee:[blanc],defense:[blanc],type:INFANTERIE,riposte:sicavalerie,cohesion:true},
        {nom:"Piquiers",pdf:true,bonusmelee:blancsicavalerie,melee:[blanc],type:INFANTERIE,defense:[jaune],riposte:sicavalerie,cout:60,moral:1},
        {nom:"Pénitents",pdf:true,melee:[blanc],defense:[],type:INFANTERIE,survie:true,faction:BIEN,desc:"%ACTIVATED%%TOURCOND% %CARTELEGENDE%: +1 %GRIS%"},
        {nom:"Sapeurs",melee:[blanc],defense:[blanc],genie:true,type:INFANTERIE,cout:120,moral:1},
        {nom:"Sergents d'armes",pdf:true,prenom:"Gascons & Bretons",melee: [rouge],defense:[noir], riposte:ftrue,type:INFANTERIE,charge:true,impetueux:true,modattaque:annule1recul,cout:125,moral:2},
        {nom:"Sergents d'armes",pdf:true,prenom:"Lourds",melee: [rouge,noir],defense:[noir], riposte:ftrue,type:INFANTERIE,cohesion:true,cout:135,moral:2},
        {nom:"Sergents d'armes montés",type:CAVALERIE,melee:[rouge],defense:[blanc],charge:true,celerite:2,moral:2,cout:110},
        {nom:"Sergents d'armes",pdf:true,melee: [rouge],defense:[rouge], riposte:ftrue,type:INFANTERIE,moral:2,cout:100},
        {nom:"Légion démoniaque",melee:[blanc],defense:[jaune,jaune],type:INFANTERIE,faction:MAL,moral:1,cout:65},
        {nom:"Squelettes",pdf:true,prenom:"Danse Macabre",melee:[jaune],defense:[],type:INFANTERIE,immortel:true,faction:MAL,desc:"%MELEE%: Squelettes%HERE% &rarr; +1 <span class='dejaune'></span>"},
        ...
        {nom:"Musicien",pdf:true,defense:[blanc],melee:[blanc],type:INFANTERIE,terreur:1,commandement:[3,1],cout:170,moral:2,desc:"%TOUTTYPE%%HERE% %MELEE% / %DEFENSE%: +1 <span class='deblanc'></span>%BR%%CAMP%: <span class='touche'></span> &rarr; <span class='rallie'></span>"},
        {nom:"Porte-Etendard",pdf:true,defense:[blanc],type:INFANTERIE,esquive:true,ralliement:true,commandement:[3,1],modattaque:annule2touche,moral:4,cout:260,desc:"%CAMP%: <span class='touche'></span> &rarr; <span class='rallie'></span>"},
        {nom:"Pavoisiers",defense:[noir,blanc],type:INFANTERIE,desc:"%TOUTTYPE%%HERE%, %DEFENSE%:  + %PARADE%",moral:1,cout:110},
        {nom:"Prêtre",pdf:true,civil:true,type:INFANTERIE,priere:true,soinbienthere:true,commandement:[1,2],commandefaction:BIEN,faction:BIEN},
        {nom:"Marchande",pdf:true,civil:true,type:INFANTERIE,desc:"%ACTIVATED%%TOURCOND%: +1 %RUMEUR%"},
        {nom:"Forgeron",pdf:true,civil:true,type:INFANTERIE,melee:[jaune],cout:160,moral:2,desc:"Paysans%HERE%: + %RIPOSTE%, <span class='melee'></span> +1 <span class='dejaune'></span>"},
        ...
        {nom:"Médecin",pdf:true,civil:true,type:INFANTERIE,defense:[blanc],soin:true,celerite:2,cout:130,moral:2,desc:"%TOUTTYPE%%HERE% %MORT%: %ROLL% <span class='dejaune'></span>, <span class='facejaune vierge'></span> &rarr; %TOUCHE%"},
    ...
    static pgs() { return [
        {nom:"Dragon",faction:MAL,type:VOLANT,melee:[rouge,rouge,rouge,blanc],tir:[rouge],portee:2,typetir:TENDU,defense:[unbouclier,unbouclier],pdv:20,terreur:2},
        ...
        {nom:"Philippe le Hardi",pdf:true,faction:FRANCAIS,type:INFANTERIE,defense:[noir,blanc],charge:true,parade:ftrue,feinte:true,dates:[1352,1404],source:"https://fr.wikipedia.org/wiki/Philippe_II_de_Bourgogne",blason:true,cout:225,moral:3 , desc:"%PERSONNAGE%%HERE% : + %PARADE%%BR%Les unités dans sa zone ne peuvent subir d'attaque de tir"},
        {nom:"Maréchal Arnoul d'Audrehem",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,rouge],defense:[noir],charge:true,impetueux:true,modattaque:annule2recul,pourfendeur:true,pdv:2,commandement:[2,1],maj:4,dates:[1351,1370],source:"https://fr.wikipedia.org/wiki/Arnoul_d%27Audrehem",blason:true},
        ...
        {nom:"Jean, fils du Roi",pdf:true,faction:FRANCAIS,type:INFANTERIE,melee:[blanc],defense:[noir],charge:true,visee:true,dates:[1356,1416], source:"https://fr.wikipedia.org/wiki/Jean_Ier_de_Berry"/* C'est Jean I de berry */,blason:true,desc:"%MONTOUR% %LEGENDE%: %PERSONNAGE%%HERE% + Survie%BR%%MELEE%: 1+ %MORT% &rarr; %LEGENDE%"},
        ...
        {nom:"Jean de Bourbon",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[blanc,blanc],defense:[rouge,rouge],charge:true,riposte:ftrue,pdv:2,commandement:[2,3],maj:4,dates:[1426,1488],source:"https://fr.wikipedia.org/wiki/Jean_II_de_Bourbon",blason:true,cout:205,moral:3,legendaire:true},
        ...
        {nom:"Jeanne d'Arc",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[blanc],defense:[noir],pdv:2,commandement:[1,1],terreur:1,survie:true,priere:true,maj:2,dates:[1428,1431],source:"https://fr.wikipedia.org/wiki/Jeanne_d%27Arc",blason:true,moral:5,desc:"%ACTIVATED%%ROUNDCOND%: en fin d'activation, jouez %JAUNE% depuis la réserve commune dans la zone sitée jusqu'à 3 zones de distance de %THIS%%BR%%CAMP%: %RETARDE% &rarr; %RALLIE%"},
        ...
        {nom:"Jeanne d'Arc",pdf:true,acheval:true,niv:1,faction:FRANCAIS,type:CAVALERIE,defense:[blanc],pdv:2,celerite:2,priere:true,parade:ftrue,commandement:[AA,2],maj:4,dates:[1428,1431],source:"https://fr.wikipedia.org/wiki/Jeanne_d%27Arc",blason:true,moral:5,cout:325,desc:"%ACTIVATED%%ROUNDCOND%: +1 %JAUNE%"},
        ...
        {nom:"Boucicaut",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[noir,noir],pdv:3,ralliement:true,commandement:[2,2],maj:4,modattaque:annule2recul,dates:[1340,1415],source:"https://fr.wikipedia.org/wiki/Jean_II_Le_Meingre",blason:true,moral:5,cout:405,desc:"%ACTIVATED% %XP%%XP%%XP% %ROUNDCOND%: +1 %BLEU%"},
        ...
        {nom:"Jean de Dunois",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,jaune,blanc],defense:[noir,noir],pdv:2,parade:ftrue,celerite:2,maj:4,commandement:[AA,1],dates:[1422,1468],source:"https://fr.wikipedia.org/wiki/Jean_de_Dunois",blason:true,cout:410,enleve1d:true,moral:5,desc:"%ONCEINGAME%: %GRIS% &rarr; %BLEU%"},
        ...
        {nom:"Jacques de Bourbon",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge],defense:[noir],pdv:2,maj:4,commandement:[AA,2],dates:[1342,1362,1393,1438],source:"https://fr.wikipedia.org/wiki/Jacques_Ier_de_Bourbon-La_Marche https://fr.wikipedia.org/wiki/Jacques_II_de_Bourbon",blason:true},
        ...
        {nom:"Comte d'Auxerre",pdf:true,faction:FRANCAIS,type:INFANTERIE,melee:[rouge,jaune,blanc],defense:[blanc,blanc],pdv:3,gardeducorps:true,commandement:[AA,1],dates:[1350,1364],source:"https://fr.wikipedia.org/wiki/Jean_III_de_Chalon-Auxerre",blason:true,cout:190,moral:3},
        {nom:"Barral de Pontevès",pdf:true,niv:2,subfaction:BIEN,faction:FRANCAIS,type:CAVALERIE,melee:[rouge,rouge],defense:[noir,blanc],charge:true,feinte:true,pourfendeur:true,pdv:3,commandement:[AA,2],dates:[1370,1390],source:"https://fr.wikipedia.org/wiki/Pontev%C3%A8s#Moyen_%C3%82ge",moral:4},    
        ...
        {nom:"Amaury de Craon",pdf:true,niv:1,faction:FRANCAIS,type:CAVALERIE,melee:[rouge],defense:[noir,noir],pdv:2,commandement:[AA,1],maj:3,dates:[1345,1373],source:"https://fr.wikipedia.org/wiki/Amaury_IV_de_Craon",blason:true,desc:"%ACTIVATED%%TOURCOND%: en début ou fin d'activation, %MOVE% %THIS%"},    
        ...
        {nom:"Erwan de Romorantin",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[rouge],defense:[noir,noir],pdv:2,commandement:[1,1],maj:3,dates:[1356,1356],cout:240,moral:3,desc:"Paysans%HERE%, Milice bourgeoise%HERE%, %MELEE% +1 <span class='deblanc'></span>"},
        ...
        {nom:"Jean de Vienne",pdf:true,niv:1,faction:FRANCAIS,type:INFANTERIE,melee:[jaune,jaune],defense:[noir],priere:true,pdv:3,modattaque:annule1touche,maj:3,dates:[1347,1347,1358,1396],source:"https://fr.wikipedia.org/wiki/Jean_de_Vienne",blason:true,cout:255,moral:3,desc:"%ACTIVATED%%ROUNDCOND%: %ROLL% 1 <span class='denoir'></span>, <span class='facenoir touche'></span> &rarr; -1 %LEGENDE% %ADVERSAIRE%"},
        ...
        {nom:"Ambroise de Loré",pdf:true,niv:1,faction:FRANCAIS,type:CAVALERIE,melee:[rouge],defense:[noir],charge:true,pdv:2,maj:4,commandement:[AA,1],commandetype:CAVALERIE,dates:[1410,1446],source:"https://fr.wikipedia.org/wiki/Ambroise_de_Lor%C3%A9",blason:true,cout:270,moral:3,desc:"%ACTIVATED%%ROUNDCOND%: +1 %VERT%"},
        ...
        {nom:"Edmond de Sommerset",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune],defense:[rouge],riposte:ftrue,charisme:true,pdv:3,maj:4,commandement:[1,1],dates:[1420,1455],source:"https://fr.wikipedia.org/wiki/Edmond_Beaufort_(1er_duc_de_Somerset)",blason:true,enleve1d:true},
        ...
        {nom:"Thomas Kyriel",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune],defense:[noir],genie:true,visee:true,pdv:2,maj:4,commandement:[2,2],dates:[1416,1461],source:"https://fr.wikipedia.org/wiki/Thomas_Kyriell",blason:true,desc:"Archers%HERE%%TOURCOND% %TIRCLOCHE%: +1 <span class='derouge'></span>%BR%%MELEE%:  <span class='facejaune vierge'></span> / <span class='facenoir vierge'></span> &rarr; %LEGENDE%"},
        {nom:"Thomas Kyriel",pdf:true,niv:2,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune,jaune],defense:[jaune,rouge],feinte:true,visee:true,pdv:3,commandement:[2,2],dates:[1416,1461],source:"https://fr.wikipedia.org/wiki/Thomas_Kyriell",blason:true,desc:"Archers%HERE%%TOURCOND% %TIRCLOCHE%: +1 <span class='derouge'></span>%BR%%MELEE%:  <span class='facejaune vierge'></span> / <span class='facenoir vierge'></span> &rarr %LEGENDE%"},
        ...
        {nom:"Comte de Northampton",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge],defense:[blanc,blanc],parade:ftrue,pdv:2,maj:3,commandement:[1,1],dates:[1339,1360],source:"https://fr.wikipedia.org/wiki/Guillaume_de_Bohun",blason:true,moral:3,cout:290,desc:"%MELEE%: %INFANTERIE%%INFANTERIE%<span class='troupe combat-cond'></span>%HERE% &rarr; +1 <span class='dejaune'></span>%BR%%TROUPE%%HERE%: + %MASSE%"},
        ...
        {nom:"Jean de Lancastre",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[blanc],defense:[jaune,jaune,blanc_blancbouclier],riposte:ftrue,pdv:2,commandement:[AA,1],maj:4,dates:[1403,1435],source:"https://fr.wikipedia.org/wiki/Jean_de_Lancastre",blason:true,cout:270,moral:3,desc:"+X %CARTELEGENDE% &rarr; +1 %CARTELEGENDE%"},
        ...
        {nom:"Sir John Jouel",pdf:true,faction:ANGLAIS,type:INFANTERIE,melee:[blanc_blanctouche,blanc_blanctouche],defense:[blanc,noir],gardeducorps:true,pdv:2,commandement:[AA,1],dates:[1353,1374],source:"https://fr.wikipedia.org/wiki/Bataille_de_Cocherel",cout:205,moral:3},
        {nom:"John Talbot",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,noir],defense:[noir],charge:true,feinte:true,pdv:2,commandement:[1,1],maj:3,dates:[1404,1453],source:"https://fr.wikipedia.org/wiki/John_Talbot_(1er_comte_de_Shrewsbury)",blason:true,cout:330,moral:3,desc:"%TROUPE%%HERE%: + %CHARGE%"},
        {nom:"John Talbot",pdf:true,niv:2,subfaction:BIEN,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,rouge],defense:[noir],feinte:true,parade:ftrue,charge:true,pdv:4,commandement:[1,3],dates:[1404,1453],source:"https://fr.wikipedia.org/wiki/John_Talbot_(1er_comte_de_Shrewsbury)",blason:true,moral:3,desc:"%MONTOUR%: +1 %GRIS%"},
        ...
        {nom:"Comte de Suffolk",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[blanc,blanc],ralliement:true,pdv:2,maj:3,commandement:[AA,1],dates:[1337,1369],source:"https://fr.wikipedia.org/wiki/Robert_d%27Ufford",blason:true,cout:260,moral:3, desc:"%ACTIVATED%%XP% %TOURCOND%: %RALLIE% %TROUPE%%HERE%"},
        ...
        {nom:"Comte de Salisbury",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,jaune],defense:[noir],ralliement:true,survie:true,pdv:2,maj:4,commandement:[1,1],dates:[1344,1397,1414,1428],source:"https://fr.wikipedia.org/wiki/William_Montagu_(2e_comte_de_Salisbury) https://fr.wikipedia.org/wiki/Thomas_Montaigu",blason:true,desc:"1 Archers%HERE%%TIRCLOCHE%: +1 <span class='derouge'></span>%BR%%MELEE%: <span class='facerouge vierge'></span> /  <span class='facejaune vierge'></span> &rarr; %XP%"},
        ...
        {nom:"Comte d'Arundel",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge],defense:[noir,jaune],riposte:ftrue,pdv:2,maj:3,commandement:[1,1],dates:[1313,1376],source:"https://fr.wikipedia.org/wiki/Richard_FitzAlan_(3e_comte_d%27Arundel)",blason:true,cout:265,moral:3,desc:"%SPECIAL%%TOURCOND%: %MOVE% %THIS% %HEREANDTHEREHEXA%"},
        ...
        {nom:"Comte de Warwick",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,noir],defense:[noir],charge:true,pourfendeur:true,pdv:3,maj:4,commandement:[1,2],dates:[1329,1369],source:"https://fr.wikipedia.org/wiki/Thomas_Beauchamp_(11e_comte_de_Warwick)",blason:true,desc:"%ACTIVATED%%TOURCOND% %XP%: %INFANTERIE%<span class='troupe combat-cond'></span>%HERE% + %CELERITE% 2"},
        ...
        {nom:"Le Prince Noir",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,rouge],defense:[noir],charisme:true,terreur:1,pdv:2,commandement:[1,1],maj:5,dates:[1346,1376],source:"https://fr.wikipedia.org/wiki/%C3%89douard_de_Woodstock",blason:true,moral:4,cout:300,desc:"%CAVALERIE%<span class='troupe combat-cond'></span>%HERE%: + %CELERITE% 2%BR%%ACTIVATED%: %MOVE% %RALLIEMENT%"},
        {nom:"Thomas de Scales",pdf:true,niv:1,faction:ANGLAIS,type:CAVALERIE,melee:[rouge],defense:[noir],relance:true,gardeducorps:true,pdv:2,maj:3,dates:[1419,1460],source:"https://fr.wikipedia.org/wiki/Thomas_de_Scales",blason:true,cout:210,moral:3,desc:"%PERSONNAGE%%HERE%: + %ESQUIVE%"},
        ...
        {nom:"Henry V",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune],defense:[blanc,blanc],feinte:true,riposte:ftrue,pdv:3,maj:4,commandement:[1,2],dates:[1410,1422],source:"https://fr.wikipedia.org/wiki/Henri_V_(roi_d%27Angleterre)",blason:true,desc:"%MONTOUR% %XP%%LEGENDE%: %BLEU%%BR%%MELEE%: <span class='facejaune bouclier'></span> / <span class='facenoir bouclier'></span> &rarr; %XP%"},
        ...
        {nom:"Assassin",pdf:true,faction:ANGLAIS,type:INFANTERIE,melee:[rouge,blanc],defense:[noir],pdv:2,riposte:ftrue,feinte:true, enleve1d:true,desc:"%REVEALED%, %MELEE%: +1 <span class='derouge'></span>"},
        ...
        {nom:"La Grande Faucheuse",pdf:true,faction:MERCENAIRE,type:VOLANT,melee:[rouge,blanc_blanctue,blanc_blanctue], defense:[noir],pdv:4,immortel:true,terreur:2,survie:true,commandement:[AA,4],desc:"%CAMP% %LEGENDE%: choisissez une unité, %ROLL% le dé du destin, %MORT% / %RETARDE% &rarr; %MORT%"},    
        ...
        {nom:"John Chandos",pdf:true,niv:2,subfaction:MAL,faction:ANGLAIS,type:INFANTERIE,melee:[noir,noir,noir],defense:[noir],pdv:4,pourfendeur:true,gardeducorps:true,commandement:[AA,3],dates:[1339,1370],source:"https://fr.wikipedia.org/wiki/John_Chandos",bonusattaque:untouchetue,blason:true,moral:3,desc:"%MONTOUR%: +1 %GRIS%%BR%%MELEE%: 1 <span class='facenoir touche'></span> &rarr; 1 <span class='facenoir tue'></span>"},
        {nom:"John Chandos",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune],defense:[rouge],pdv:2,riposte:ftrue,mercenaire:true,commandement:[AA,1],maj:2,dates:[1339,1370],source:"https://fr.wikipedia.org/wiki/John_Chandos",blason:true,moral:3,cout:290,desc:"%CONSEIL%: +1 %CARTELEGENDE%"},
        {nom:"Simon Morhier",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[rouge],defense:[noir],pdv:2,genie:true,maj:2,dates:[1422,1429],source:"https://fr.wikipedia.org/wiki/Simon_Morhier",cout:195,moral:3,desc:"%INFANTERIE%<span class='troupe combat-cond'></span>%HERE%%MELEE%: +1 <span class='deblanc'></span>"},    
        ...
        {nom:"John Fastolf",pdf:true,niv:1,faction:ANGLAIS,type:INFANTERIE,melee:[noir,jaune],defense:[jaune,jaune],pdv:2,riposte:ftrue,esquive:true,commandement:[AA,1],maj:3,dates:[1410,1459],source:"https://fr.wikipedia.org/wiki/John_Fastolf",blason:true,desc:"%DEFENSE%: %RECUL% &rarr; vous pouvez déplacer %THIS% jusqu'à 2 zones"},
        {nom:"Jean Stuart de Derneley",pdf:true,niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[noir,noir],defense:[noir],pdv:2,impetueux:true,charge:true,feinte:true,maj:2,commandement:[AA,1],dates:[1421,1429],source:"https://fr.wikipedia.org/wiki/John_Stuart_de_Darnley",blason:true,cout:320,moral:4,desc:"%MELEE%: %MORT% &rarr; reprenez le jeton de relance si vous ne l'avez plus"},
        {nom:"Jean Stuart de Derneley",pdf:true,niv:2,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,noir],defense:[noir],pdv:3,feinte:true,charge:true,modattaque:annule1recul,commandement:[AA,2],dates:[1421,1429],source:"https://fr.wikipedia.org/wiki/John_Stuart_de_Darnley",blason:true,moral:4,desc:"%MELEE%: %MORT% &rarr; reprenez le jeton de relance si vous ne l'avez plus%BR%%POURSUITE%: +1 %LEGENDE%"},    
        {nom:"William Wallace",pdf:true,niv:2,subfaction:BIEN,faction:ECOSSAIS,type:INFANTERIE,melee:[blanc,blanc],defense:[blanc,jaune],pdv:2,impetueux:true,charge:true,commandement:[1,3],dates:[1296,1305],source:"https://fr.wikipedia.org/wiki/William_Wallace",blason:true,moral:3,desc:"%POURSUITE%%ROUNDCOND%: +1 %MELEE%%BR%%DEFENSE%: %RECUL% &rarr; %CHOOSERECUL%"},    
        ...
        {nom:"Jean Stuart de Buchan",pdf:true,niv:1,faction:ECOSSAIS,type:INFANTERIE,melee:[rouge,blanc],defense:[noir],commandement:[AA,1],pdv:2,feinte:true,charge:true,maj:4,dates:[1404,1424],source:"https://fr.wikipedia.org/wiki/John_Stuart_(3e_comte_de_Buchan)",blason:true,cout:300,moral:3,desc:"%TROUPE%%TROUPE%<span class='combat-cond tirtendu'></span><span class='combat-cond tircloche'></span>%HERE%: +1 <span class='dejaune'></span>"},    
        ...
        {nom:"John Hawkwood",pdf:true,faction:MERCENAIRE,type:INFANTERIE,melee:[noir_bouclierrecule],defense:[blanc],pdv:2,mercenaire:true,feinte:true,commandement:[1,2],dates:[1342,1394],source:"https://fr.wikipedia.org/wiki/John_Hawkwood",blason:true,desc:"%ACTIVATED%%ROUNDCOND% %XP%: +1 %BLEU%"}, 
        ...
        {nom:"Mehmet II",pdf:true,niv:1,faction:OTTOMAN,type:INFANTERIE,melee:[noir],defense:[noir,blanc],relance:true,priere:true,ralliement:true,pdv:2,commandement:[1,1],maj:4,dates:[1444,1481],source:"https://fr.wikipedia.org/wiki/Mehmed_II"},
        ...
        {nom:"Radu III le Beau",pdf:true,niv:2,faction:VALAQUE,type:INFANTERIE,melee:[blanc,blanc],defense:[noir],charisme:true,feinte:true,pdv:2,commandement:[1,1],dates:[1462,1475],source:"https://fr.wikipedia.org/wiki/Radu_III_le_Beau",blason:true,desc:"%ACTIVATED% %XP%: %MOVE% une unité ennemie d'une zone"},
        ...
        {nom:"Sorcière",pdf:true,niv:1,faction:MAL,type:INFANTERIE,melee:[jaune],defense:[jaune],esquive:true,commandement:[AA,1],maj:4,cout:145,moral:3,desc:"%MONTOUR%: +1 %CARTELEGENDE%"},
        ...
        {nom:"Dracula",pdf:true,niv:1,faction:MAL,type:INFANTERIE,melee:[rouge,rouge],defense:[rouge,noir],pdv:3,saut:2,terreur:1,commandement:[2,1],maj:5,desc:"%ACTIVATED% %LEGENDE% %ROUNDCOND%: + <span class='commandement'>&nbsp;&nbsp;&nbsp; 1</span>%BR%+1 %BLESSURE% &rarr; %LEGENDE% / %XP%"},
        ...
        {nom:"La Licorne",pdf:true,faction:BIEN,type:INFANTERIE,melee:[blanc,blanc],defense:[blanc,blanc],parade:ftrue,pdv:5,soin:true,celerite:2,legendaire:true,desc:"%MELEE% / %DEFENSE%: 1 <span class='faceblanc vierge'></span> &rarr;  <span class='faceblanc touche'></span>  / <span class='faceblanc bouclier'></span>  / <span class='faceblanc recul'></span>"},
        {nom:"L'Inquisiteur",pdf:true,faction:BIEN,type:INFANTERIE,defense:[noir],pdv:2,priere:true,commandement:[2,1],desc:"%MONTOUR%: %ROLL% <span class='denoir'></span>: <span class='facenoir bouclier'></span> &rarr; prenez 1 %XP% / %LEGENDE% %ADVERSAIRE%%BR%%ACTIVATED% %LEGENDE%%LEGENDE%: +1 %RUMEUR%%BR%%THIS% peut seulement commander le Bourreau"},
        {nom:"Le Griffon",pdf:true,faction:BIEN,type:VOLANT,melee:[noir_bouclierrecule,jaune_bouclierrecule,blanc_bouclierrecule],defense:[blanc,blanc],pdv:4,grand:true,saut:2,feinte:true,pourfendeur:true,charge:true,desc:"%THIS% peut utiliser le trait charge à partir d'un hexagone de ciel"},
        {nom:"Archange Gabriel",pdf:true,niv:1,faction:BIEN,type:VOLANT,melee:[rouge,rouge,rouge],defense:[noir,noir],pdv:6,saut:2,gardeducorps:true,commandement:[1,1],maj:4,desc:"%MELEE%: %BOUCLIER% &rarr; %BONUSMOVE%"},
        ...
        {nom:"Archevêque Pierre de Cros",pdf:true,niv:1,faction:BIEN,type:INFANTERIE,defense:[rouge],pdv:2,priere:true,commandement:[AA,2],maj:2,dates:[1362,1388],source:"https://fr.wikipedia.org/wiki/Pierre_de_Cros"},
        ...
        {nom:"Sainte Marthe",pdf:true,niv:1,faction:BIEN,type:INFANTERIE,melee:[jaune],defense:[noir],priere:true,maj:5,noterreur:true,modattaque:touchetuerecul},
...
*/
    ...
    constructor(u,n) {
        ...
        if (this.defense) {
            ...
            console.log("defense with "+this.defense.length+" dices");
    ...
    toHTML() {
        ...
        let n=this.nom;
        if (this.pdf&&!this.troupe) n="<a href='#card' data-toggle='modal' data-target='#card' onclick=\"document.getElementById('mycard').setAttribute('src','https://xws-bench.github.io/joan-of-arc-helper/cards/"+nn+".pdf#toolbar=0')\">"+this.nom+"</a>";
        if (this.troupe&&this.pdf) n="<a href='#card-troop' data-toggle='modal' data-target='#card-troop' onclick=\"document.getElementById('mycardtroop').setAttribute('src','https://xws-bench.github.io/joan-of-arc-helper/cards/"+nn+".pdf#toolbar=0')\">"+this.nom+"</a>";
